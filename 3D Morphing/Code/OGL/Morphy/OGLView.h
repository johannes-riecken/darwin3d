...
// Overrides
	...
	public:
	virtual bool Create(const char* lpszClassName, const char* lpszWindowName, unsigned int dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CSlider *slider, CCreateContext* pContext = NULL);
	//}}AFX_VIRTUAL
