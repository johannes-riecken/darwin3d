...
static char TextureFiles[NUM_TEXTURES][80] = {
	"DogPoker.tga",
	"Wood.tga",
	"NewCastle.tga",
	"Guinness.tga",
...
void LoadTextures()
{
	...
	for (i = 0; i < 8; i++)
	{
		sprintf(g_TexPool[g_TextureCnt].map,"%s%s",ART_PATH,TextureFiles[i]);
...
///////////////////////////////////////////////////////////////////////////////
	...
	if (fp != NULL)
	{
		...
		visual->vertex = (tVector3 *)malloc(sizeof(tVector3) * visual->vertexCnt);
		fread(visual->vertex,sizeof(tVector3),visual->vertexCnt,fp);
