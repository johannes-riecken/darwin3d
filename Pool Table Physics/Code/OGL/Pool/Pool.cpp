/////////////////////////////////////////////////////////////////////////////////////
// Pool.c
// This is the application shell for the Pool simulator
//
...
static const char* lpszAppName = "GL Pool";
static HINSTANCE hInstance;


// Declaration for Window procedures
// Defined in this file (Pool.c)
							...
							LPARAM  lParam)
{
	switch (message)
		...
		case WM_CREATE:
			...
			CheckMenuItem((HMENU)hMenu,ID_USE_FRICTION,MF_BYCOMMAND | MF_CHECKED);
			...
			switch(LOWORD(wParam))
				...
				case ID_USE_FRICTION:
					...
					if (g_UseFriction)
					{
						...
						CheckMenuItem((HMENU)hMenu,ID_USE_FRICTION,MF_BYCOMMAND | MF_UNCHECKED);
