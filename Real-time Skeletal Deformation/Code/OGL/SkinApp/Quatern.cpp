...
///////////////////////////////////////////////////////////////////////////////
void ScaleVector(tVector *vect, const float scale)
{
	vect->x *= scale;
	vect->y *= scale;
	vect->z *= scale;
...
///////////////////////////////////////////////////////////////////////////////
void AddVectors(const tVector *vect1, const tVector *vect2, tVector *dest)
{
...
// Returns:		Dot product
///////////////////////////////////////////////////////////////////////////////
float DotVectors(const tVector *vect1, const tVector *vect2)
{
...
// Arguments:	pointer to vectors and dest
///////////////////////////////////////////////////////////////////////////////
void CrossVectors(const tVector *vect1, const tVector *vect2, tVector *dest)
{
...
///////////////////////////////////////////////////////////////////////////////
void MultQuaternions(const tQuaternion *quat1, const tQuaternion *quat2, tQuaternion *dest)
{
/// Local Variables ///////////////////////////////////////////////////////////
...
// Arguments:	pointer to quaternions and dest
///////////////////////////////////////////////////////////////////////////////
void MultQuaternions2(const tQuaternion *quat1, const tQuaternion *quat2, tQuaternion *dest)
{
    tQuaternion tmp;
...
///////////////////////////////////////////////////////////////////////////////
void SlerpQuat2(const tQuaternion *quat1,const tQuaternion *quat2,const float slerp, tQuaternion *result)
{
/// Local Variables ///////////////////////////////////////////////////////////
	tQuaternion quat1b;
