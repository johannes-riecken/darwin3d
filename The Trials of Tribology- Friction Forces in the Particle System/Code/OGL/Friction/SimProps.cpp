	...
	: CDialog(CSimProps::IDD, pParent)
{
	...
	m_UserForceMag = 0.0f;
	m_MouseSpring = 0.0f;
	m_CoefKineticFriction = 0.0f;
	m_CoefStaticFriction = 0.0f;
	//}}AFX_DATA_INIT
}
...
void CSimProps::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_MOUSESPRING, m_MouseSpring);
	DDX_Text(pDX, IDC_KINETICFRICTION, m_CoefKineticFriction);
	DDX_Text(pDX, IDC_STATICFRICTION, m_CoefStaticFriction);
	//}}AFX_DATA_MAP
}
